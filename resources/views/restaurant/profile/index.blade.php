    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl border border-zinc-200 shadow-sm">
            <div class="p-6 border-b border-zinc-200">
                ...
                <p class="text-sm text-zinc-500 mt-1">Your restaurant details and contact information.</p>
            </div>
            <div class="p-6 space-y-6">
                <!-- Restaurant Name -->
                <div>
                    <p class="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Restaurant Name</p>
                    <p class="text-sm font-medium text-zinc-900">{{ $profile->restaurant_name }}</p>
                </div>

                <!-- Cuisine Type -->
                <div>
                    <p class="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Cuisine Type</p>
                    <p class="text-sm font-medium text-zinc-900">{{ ucfirst($profile->cuisine_type) }}</p>
                </div>
                ...
                @if($profile->website)
                <div>
                    <p class="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Website</p>
                    <a href="{{ $profile->website }}" target="_blank" class="text-sm font-medium text-emerald-600 hover:text-emerald-700 inline-flex items-center gap-1">
                ...
                <!-- Business Hours -->
                <div>
                    <p class="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Business Hours</p>
                ...
                <div>
                    <p class="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Description</p>
                    <p class="text-sm text-zinc-900 leading-relaxed">{{ $profile->description }}</p>
                </div>
                @endif
            </div>
        </div>
