...
<head>
    ...
    <title>Listing Approvals - MyFoodshare Admin</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 text-emerald-600">
                        <i data-lucide="arrow-left" class="w-4 h-4"></i>
                    </a>
                    <div>
                        <h1 class="text-xl font-semibold tracking-tight text-zinc-900">Listing Approvals</h1>
                        <p class="text-sm text-zinc-500">Review and approve food donation listings</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    <span class="text-sm text-zinc-500">{{ $foodListings->total() }} listings</span>
                </div>
            </div>
        </div>
    </div>
